  ...
  useEffect(() => {
    ...
    loadMermaid()
      .then(async (mermaid) => {
        ...
        // securityLevel:"strict" makes mermaid sanitize its own SVG output (via
        // DOMPurify, which the root pnpm override pins to a patched >=3.4.9).
        // A second DOMPurify pass here is not viable: it strips the HTML inside
        // mermaid's <foreignObject> labels (an intentional anti-mXSS measure),
        // which would blank out sequence/class/state diagram labels.
